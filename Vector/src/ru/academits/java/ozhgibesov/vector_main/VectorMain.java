...
public class VectorMain {
    public static void main(String[] args) {
        ...
        System.out.printf("Результат создания вектора Vector(5, new double[]{ 1, 2, 3 }): %s%n", vector4);
        ...
        System.out.printf("Длина vector4 составляет: %s%n", vector4.getLength());

        vector4.setComponent(4, 5.5);
        System.out.printf("Результат установки значения 5.5 элементу по индексу 4 в vector4 : %s%n", vector4);
        ...
        System.out.println("Результат сложения vector3 + vector5 через статическую функцию = " + Vector.getSum(vector3, vector5));
        System.out.println("Результат вычитения vector1 - vector3 через статическую функцию = " + Vector.getDifference(vector1, vector3));
        System.out.println("Результат скалярного произведения vector5 * vector6 через статическую функцию = " + Vector.getScalarMultiplication(vector5, vector6));
    }
}